...
<div class=" justify-between flex">
   ...
   <button @click="closeSidebar()" type="button" :class="{' hidden' : !isOpen}" class=" px-6 inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden ">
    X
   </button>
</div>
